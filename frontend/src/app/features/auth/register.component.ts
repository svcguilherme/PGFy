        ...
        <mat-card-content>
          <form [formGroup]="form" (ngSubmit)="submit()">
            <mat-form-field appearance="outline" class="full-width">
              ...
              <input matInput formControlName="nomeCompleto" autocomplete="name" />
            </mat-form-field>
            <mat-form-field appearance="outline" class="full-width">
...
export class RegisterComponent {
  ...
  submit(): void {
    ...
    const { nomeCompleto, email, password } = this.form.value;
    this.auth.register({ nomeCompleto: nomeCompleto!, email: email!, password: password! }).subscribe({
