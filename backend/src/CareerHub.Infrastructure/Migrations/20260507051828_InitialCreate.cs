        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiaDaSemana = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Descricao = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ValorPrevisto = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    DataPrevista = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_refresh_tokens_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_despesas_UsuarioId_DataPrevista",
                table: "despesas",
                columns: new[] { "UsuarioId", "DataPrevista" });

            migrationBuilder.CreateIndex(
                name: "IX_estudos_UsuarioId_DiaDaSemana",
                table: "estudos",
                columns: new[] { "UsuarioId", "DiaDaSemana" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_recebiveis_UsuarioId",
                table: "recebiveis",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_recebiveis_UsuarioId_DataPrevista",
                table: "recebiveis",
                columns: new[] { "UsuarioId", "DataPrevista" });
